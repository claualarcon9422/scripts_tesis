...
entrenar_y_graficar <- function(X,y, tipo, variable, titulo){
  ...
  #print(min(fechas_entrenamiento))
  #print(max(fechas_entrenamiento))
  #print(min(fechas_prueba))
  #print(max(fechas_prueba))
...
entrenar_y_graficar(X,y, "temp", "Temperatura Máxima [°C]", "Serie Temporal Normalizada de Temperatura Máxima y\n Predicciones con Red Neuronal")
X <- NULL
y <- NULL
X <- windows_pr$X
y <- windows_pr$y
entrenar_y_graficar(X,y, "prec", "Precipitación Máxima [mm]", "Serie Temporal Normalizada de Precipitación Máxima y\n Predicciones con Red Neuronal")
